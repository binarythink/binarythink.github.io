...
header:
  teaser: /assets/images/content/2016/10/java-encrypt/teaser.png
...
[^password]: 패스워드를 SHA256을 사용하게 되는 경우 발생할 수 있는 문제점에 대한 글을 확인해서 본 블로그의 글을 수정하고 관련 게시물을 공유합니다. Naver D2 블로그 '안전한 패스워드 저장'의 단방향 해시 함수의 문제점 부분에서 패스워드로 SHA-256 암호화를 사용하면 어떤 문제가 있는지 자세히 확인 하실 수 있습니다. [바로가기](http://d2.naver.com/helloworld/318732)
